    ...
    <section className='py-16' id='contact' ref={contactRef}>
        <div className='px-4 text-center'>
            ...
            <p className='contact-text mb-4 text-lg lg:text-xl'>
                ...
                <a href="mailto:ayazansari3245@gmail.com" className='border-b'>
                    ayazansari3245@gmail.com
                </a>
            </p>
            <div className='mt-8 flex justify-center space-x-6'>
                <a href="https://linkedin.com/in/ayaz-zafar"
                target='_blank'
                ...
                <a href="https://www.figma.com/@ayazansari3245"
                target='_blank'
                rel='noopener noreferrer'
                className='contact-icon'
